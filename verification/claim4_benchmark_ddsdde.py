...
What this script does
    ...
    then both Abaqus jobs, one at a time, named verify_c4_<case>_{orig,oti}
    ...
    python verification/claim4_benchmark_ddsdde.py --abaqus            # all cases
    python verification/claim4_benchmark_ddsdde.py --abaqus --case UMAT_HIN
    python verification/claim4_benchmark_ddsdde.py                     # transform + workspace only
"""
...
JOB_PREFIX = os.environ.get("PRESENTATION_ABAQUS_PREFIX4", "verify_c4")
...
def run_pair(validation_dir: Path, case: str) -> Dict[str, object]:
    """Both jobs, one at a time, under verify_ names; outputs renamed for the extractor."""
