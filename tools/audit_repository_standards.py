#!/usr/bin/env python
"""Audit Residual_Assembler against the standards a SoftwareX reviewer expects.
...
REQUIRED_FILES = (
    "README.md", "START_HERE.md", "LICENSE", "CITATION.cff", "codemeta.json",
    ".zenodo.json", "CHANGELOG.md", "CONTRIBUTING.md", "CODE_OF_CONDUCT.md",
    "SECURITY.md", "AUTHORS.md", "THIRD_PARTY_LICENSES.md", ".gitignore",
