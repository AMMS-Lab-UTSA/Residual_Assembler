...
| 19 | 207 UMATs collected by web scraping, full set re-run after every fix | **Re-run at the final transform** (pass14, fingerprint `da1f183708c19072`, 2026-09-18): 391 acquired sources re-transformed (244 transform), all 244 run in Abaqus 2021.HF5; 43 of the 260 adequately specified genuine UMATs clear every acceptance gate, the same 43 as pass13. The slide's 207 is an older count of the acquisition. Evidence: [final_refreeze.md](evidence/final_refreeze.md); census in UMAT_source_transformation `paper_results/corpus/`. |
