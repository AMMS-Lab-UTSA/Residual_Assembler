...
See [REQUEST_INTERFACE.md](REQUEST_INTERFACE.md) for format and limits;
...
This is a runnable Program 1 -> Program 2 integration on a bounded model, not
the full-size cantilever (for that, see `examples/cantilevers/`). Program 1 freshly transforms and compiles the ORIGINAL
