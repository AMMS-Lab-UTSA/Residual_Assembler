...
GUI launch and genuine source-denied ODB consumption. The pinned compiled J2
provider/replay and bounded total neo-Hookean finite formulation now have
independent numerical evidence; generic FCC/full-size/higher-order full FE do not.
Retained corpus counts are historical. Latest retained full suites: RA 419
passed/11 existing skips; UMAT 3324 passed/125 existing skips/5 deselected,
before the new wrapper regression. No new analysis job or producer edit occurred
in this usage audit. The recovery worktrees remain uncommitted.
