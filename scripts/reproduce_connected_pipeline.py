...
def main(argv=None):
    ...
    parser.add_argument("--model", type=Path, default=ROOT / "examples/bounded_j2_c3d8/model.json")
    ...
    try:
        ...
        manifest["repositories"] = {
            "residual_assembler": repository_info(ROOT, ["residual_core/**/*.py", "scripts/reproduce_connected_pipeline.py",
                                                         "examples/bounded_j2_c3d8/*", "tests/abaqus_derivative_export/**/*"]),
